...
//kai开起服务
    ...
    private void initListener() {
        ...
        trackListener = new OnTrackListener() {
            ...
            @Override
            public void onLatestPointCallback(LatestPointResponse response) {//初始化定位
                ...
                Log.i("=====imei",imei);
                new UPDataAsyncTask(CurrentLocation.longitude+"",CurrentLocation.latitude+"",imei).execute();
                if (null != mapUtil) {
        ...
        entityListener = new OnEntityListener() {
            @Override
            public void onReceiveLocation(TraceLocation location) {//实实定位
            //TODO  实实定位
                Log.i("=====imei",imei);
                new UPDataAsyncTask(location.getLongitude()+"",location.getLatitude()+"",imei).execute();
        ...
        traceListener = new OnTraceListener() {//开启服务状态
    ...
    class UPDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        private UPDataAsyncTask(String lo,String la,String imei) {
            this.la=la;
            this.lo=lo;
            this.imei=imei;
        }
...
//获取当前时间
            ...
            try {
                String code=Mypoint_UP.Up_Request(lo,la,imei,simpleDateFormat.format(date));
                Log.i("=====code",code);
            } catch (Exception e) {
                e.printStackTrace();
            }
